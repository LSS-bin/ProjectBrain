...
public class OVRCameraRig : MonoBehaviour
{
	...
	/// </summary>
    [Tooltip("true이면 별도의 카메라가 왼쪽 눈과 오른쪽 눈에 사용됩니다. If true, separate cameras will be used for the left and right eyes.")]
	...
	/// </summary>
    [Tooltip("true로 설정하면 업데이트 된 모든 앵커가 업데이트 대신 FixedUpdate로 업데이트되어 물리 충실도가 향상됩니다. note : 고정 된 업데이트 속도가 렌더링 프레임 속도 (OVRManager.display.appFramerate)와 일치하지 않으면 앵커가 눈에 띄게 흔들립니다.")]
